...
qm create "$VMID" --memory 4096 --cores 2 --cpulimit 2 --name "$DISTRO" --cpu x86-64-v4 --machine q35,viommu=intel --ostype l26 --agent enabled=1 --net0 virtio,bridge=vmbr0,firewall=1 --onboot 1 --tags "$DISTRO" --template 1
