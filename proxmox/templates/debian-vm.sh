...
qm set 2100 --bios ovmf --efidisk0 local-zfs:4,efitype=4m,pre-enrolled-keys=1
qm importdisk 2100 /var/lib/vz/template/iso/debian-12-generic-amd64.qcow2 local-zfs
qm set 2100 --scsihw virtio-scsi-pci --scsi0 local-zfs:vm-2100-disk-1,discard=on,ssd=1
