...
qm set 2000 --bios ovmf --efidisk0 local-zfs:4,efitype=4m,pre-enrolled-keys=1
qm importdisk 2000 /var/lib/vz/template/iso/generic_alpine-3.21.2-x86_64-bios-cloudinit-r0.qcow2 local-zfs
qm set 2000 --scsihw virtio-scsi-pci --scsi0 local-zfs:vm-2000-disk-1,discard=on,ssd=1
