...
qm set 2200 --bios ovmf --efidisk0 local-zfs:4,efitype=4m,pre-enrolled-keys=1
qm importdisk 2200 /var/lib/vz/template/iso/oracular-server-cloudimg-amd64.img local-zfs
qm set 2200 --scsihw virtio-scsi-pci --scsi0 local-zfs:vm-2200-disk-1,discard=on,ssd=1
